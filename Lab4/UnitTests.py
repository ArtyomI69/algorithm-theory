...
#  unit-тесты для функции insertion_sort
class TestGnomeSort(unittest.TestCase):
    ...
    def test_sorted_array(self):
        ...
        self.assertEqual(insertion_sort(self.sorted_arr), sorted(self.sorted_arr))

    def test_reverse_sorted_array(self):
        # Проверяем, что функция правильно сортирует обратно отсортированный массив
        self.assertEqual(insertion_sort(self.reverse_arr), sorted(self.reverse_arr))

    def test_random_array(self):
        # Проверяем, что функция правильно сортирует случайный массив
        self.assertEqual(insertion_sort(self.random_arr), sorted(self.random_arr))

    def test_empty_array(self):
        # Проверяем, что функция корректно обрабатывает пустой массив
        self.assertEqual(insertion_sort(self.empty_arr), [])
